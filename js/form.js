var sDivId          = "event",
    ...
    sLeftLabelClass = "col-sm-2",
    sMiddleDivClass = "col-sm-10",
    sRightDivClass  = "",

    sId             = "",
    sSubject        = "",
    sBody           = "",
    sTags           = "private_ticket,lsipriority_standard,product_other,update_docs_no,lsistatus_new",
    iRequesterId    = 829105737, //sean by default
    iAssigneeId     = "",
    sOrganization   = "",
    iFormId         = "151068", //non-programming requests by default
    iRepeats        = 0,
    sDate           = "",
    iOnlyOn         = 0,
    sActive         = "y",
    ...
    sBaseUrl        = "https://www.lsitools.com";
...
//alert("iOnlyOn = " + iOnlyOn)
    ...
    function fillAuthors() {
        ...
        var sAuthUrl = "/json/authors.json"
    ...
    function fillOrgs() {
        ...
        returnJSON("/json/orgs.json", true, fillOrgsData)
    }
    ...
    function fillForms() {
        ...
        returnJSON("/json/forms.json", true, fillFormsData)
    }
    ...
    function showReportData(data) {
        ...
        $("#oreport").append("<table id='oreporttablekey' class='pricing-table' style='width: 300px'><tr><td class='warning'><s>Yellow = Not Active</td><td class='success'>Green = Active</td></tr></table>")
        $("#oreport").append("<a class='button large' href='#' onclick='showEditor(); return false;'>Add New Event</a>")
        $("#oloadergif").hide()
    }
    ...
    function showReport() {
        ...
        $("#oreport").empty()
        $("#oreport").show()
        returnJSON("/json/report.json", true, showReportData)
    }
    ...
    function loadEditor(iId) {
        ...
        var sUrlAddOn = "/json/report.json";
